"""
Django settings for appointexam project.
...
SECRET_KEY = 'django-insecure-o9!fze_3g@7!f!bw8#t)@-^yg_s)m2jowu%w&b-$h3iug@xf8$'
...
WSGI_APPLICATION = 'appointexam.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'examen3', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
